...
namespace Disney.iDash.Startup
{
    static class Program
    {
        ...
        static void Main()       
		{
            ...
            if (singleInstance.IsRunning && !System.Diagnostics.Debugger.IsAttached)
            ...
            else
            {
                ...
                if (SetLocalDataLocation())
                {
                    ...
                    while (!exit && ShowLogin())
                    {
                        ...
                        mainForm.DemonInterval = Properties.Settings.Default.DemonInterval;

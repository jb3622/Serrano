...
namespace Disney.iDash.SRR.UI.Forms.Workbench
{
    public partial class DetailedFocusGroupsForm : Disney.iDash.SRR.UI.Forms.Common.BaseParameters
    {
        ...
        private void RefreshControls()
        {
            ...
            string workBench;
            switch (this.DepartmentSelector.Workbench)
            {
                case Constants.Workbenches.Daily:
                    workBench = "D";
                    break;
                case Constants.Workbenches.Weekly:
                    workBench = "W";
                    break;
                case Constants.Workbenches.Both:
                    workBench = "B";
                    break;
                default:
                    workBench = "B";
            ...
            switch ((DetailedWorkbenchInfo.FocusGroups) rgFocusGroup.EditValue)
            {
                ...
                case DetailedWorkbenchInfo.FocusGroups.FastestCoverStores:
				    base.Instance.RefreshFocusGroupsCoverStores(workBench);

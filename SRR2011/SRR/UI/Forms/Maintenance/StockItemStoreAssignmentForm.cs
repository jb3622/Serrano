...
namespace Disney.iDash.SRR.UI.Forms.Maintenance
{
    public partial class StockItemStoreAssignmentForm : Disney.iDash.SRR.UI.Forms.Common.BaseDataForm
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (_stockInfo.Lock((decimal)cboDept.EditValue, userId, out actionResult))
            {
                RefreshGrid();
            }
            else
            {
                UpdateStatusMessage(actionResult, true);
            }      
        }
        ...
        private void StockItemStoreAssignmentForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            string userId = Session.User.NetworkId.ToUpper();

namespace Disney.iDash.SRR.UI.Forms.Common
{
    partial class BaseParameters
    {
        ...
        private void InitializeComponent()
        {
			...
			this.BoxStyles = new DevExpress.XtraEditors.StyleController(this.components);
            ...
            this.riProgress});
			this.ribbon.Size = new System.Drawing.Size(475, 27);
			...
			// barProgress
			// 
			this.barProgress.Edit = this.riProgress;
			...
			// ribbonStatusBar
			// 
			this.ribbonStatusBar.Font = new System.Drawing.Font("Arial", 8F);
			this.ribbonStatusBar.ItemLinks.Add(this.barStatus);
			this.ribbonStatusBar.ItemLinks.Add(this.barProgress, true);
			...
			this.ribbonStatusBar.Size = new System.Drawing.Size(475, 31);
			// 
			// ClientPanel
			// 
			...
			this.ClientPanel.Size = new System.Drawing.Size(475, 412);
			this.ClientPanel.TabIndex = 7;
			this.ClientPanel.Tag = "SRR";
			// 
			// BoxStyles
			// 
			...
			this.Name = "BaseParameters";
			this.Ribbon = this.ribbon;
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.StatusBar = this.ribbonStatusBar;
			this.Text = "CHANGE THE CAPTION";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.BaseParameters_FormClosing);
		...
		public DevExpress.XtraEditors.StyleController BoxStyles;
        private DevExpress.XtraEditors.Repository.RepositoryItemProgressBar riProgress;
		public DevExpress.XtraBars.BarStaticItem barStatus;
		public DevExpress.XtraBars.BarEditItem barProgress;
